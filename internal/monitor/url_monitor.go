...
import (
	...
	_ "github.com/bkaygisiz/url-shortener/internal/models"   // Importe les modèles de liens
	"github.com/bkaygisiz/url-shortener/internal/repository" // Importe le repository de liens
)
